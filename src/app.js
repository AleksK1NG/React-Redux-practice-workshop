...
import ArticleListNew from "./components/NewArticlesList/NewArticlesList";
      ...
      <LangProvider language={this.state.language}>
        <div>
          ...
          <UserProvider value={this.state.username}>
            <Menu>
              <MenuItem path="/test">Test Box Component</MenuItem>
              ...
              <MenuItem path="/new">New Articles</MenuItem>
            </Menu>
            <Switch>
              ...
              <Route path="/new" component={ArticleListNew} />
